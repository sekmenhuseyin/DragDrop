...
Public Class MainForm
    ...
    ''' </summary>
    Private Sub txtSource_MouseDown(ByVal sender As System.Object, ByVal e As MouseEventArgs) Handles txtSource.MouseDown
    ...
    ''' clicked.
    ''' </summary>
    Private Sub PictureBox_MouseDown(ByVal sender As System.Object, ByVal e As MouseEventArgs) Handles picLeft.MouseDown, picRight.MouseDown
        If e.Button = MouseButtons.Left Then
    ...
    ''' </summary>
    Private Sub PictureBox_DragEnter(ByVal sender As System.Object, ByVal e As DragEventArgs) Handles picLeft.DragEnter, picRight.DragEnter
    ...
    ''' </summary>
    Private Sub PictureBox_DragDrop(ByVal sender As System.Object, ByVal e As DragEventArgs) Handles picLeft.DragDrop, picRight.DragDrop
    ...
    ''' </summary>
    Private Sub TreeView_DragDrop(ByVal sender As System.Object, ByVal e As DragEventArgs) Handles tvwLeft.DragDrop, tvwRight.DragDrop
    ...
    ''' </summary>
    Private Sub TreeView_DragEnter(ByVal sender As System.Object, ByVal e As DragEventArgs) Handles tvwLeft.DragEnter, tvwRight.DragEnter
        ' Check to be sure that the drag content is the correct type for this 
        ' control. If not, reject the drop.
    ...
    ''' </summary>
    Private Sub TreeView_ItemDrag(ByVal sender As System.Object, ByVal e As ItemDragEventArgs) Handles tvwLeft.ItemDrag, tvwRight.ItemDrag
        If e.Button = MouseButtons.Left Then
            'invoke the drag and drop operation
    ...
    ''' event that fires when an object is dragged into the control's bounds.
    ''' </summary>
    Private Sub txtUpperRight_DragEnter(ByVal sender As System.Object, ByVal e As DragEventArgs) Handles txtAllowDrop.DragEnter
        ' Check to be sure that the drag content is the correct type for this 
        ' control. If not, reject the drop.
    ...
    ''' </summary>
    Private Sub txtAllowDrop_DragDrop(ByVal sender As System.Object, ByVal e As DragEventArgs) Handles txtAllowDrop.DragDrop
